...
function MainMenuCredits:init(menu)
    ...
    self.pages = {
        ...
        {
            "Miles Mechanical Mayhem",
            {
                {"Lead Developer", COLORS.silver},
                "Zibus",
                "",
                {"Sprites/Music", COLORS.silver},
                "Toby Fox",
                "Temmie Chang",
                "Soup",
                "Doru",
            ...
            {
                {"Programming", COLORS.silver},
                "Verozity",
                "Hyperboid",
                "",
                {"Betatesters", COLORS.silver},
                "v1 plushie",
                "Dane",
            }
        },
        {
            "Miles Mechanical Mayhem",
            {
        {"Special Thanks", COLORS.yellow},
        "Kristal Discord Server",
        "Vitellary",
        "MrFukuoScarm",
        "AcousticJamm",
        "FireRainV",
    ...
    },
    {
        ...
        "Miles Team",
        "",
        {"VERY Special Thanks", COLORS.yellow},
